var app = new $.mvc.app();
app.loadControllers(["qsim"]); //You can pass in array or a string.  You do not need to reference the .js extension.
...
app.ready(function(){
	console.log("ready");
    $.mvc.route("/qsim"); //When the app launches, go to the default route for "hello"
});
